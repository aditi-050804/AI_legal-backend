...
async function runTests() {
    console.log("=== RUNNING APPLE PAY VERIFICATION ENDPOINT TESTS ===");
    ...
    {
        console.log("[Apple Pay - Test Case 1] Localhost Request");
    ...
    {
        console.log("[Apple Pay - Test Case 2] Sandbox environment request");
    ...
    {
        console.log("[Apple Pay - Test Case 3] Production environment with missing signature params");
