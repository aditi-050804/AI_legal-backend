import { c as createLucideIcon, r as reactExports, b$ as useActiveCase, b_ as useOutputLanguage, c0 as mapCaseToForm, z as zt, cc as generateChatResponse, j as jsxRuntimeExports, a4 as ChevronLeft, l as Shield, c7 as History, h as Database, cj as ShieldCheck, n as TriangleAlert, t as Scale, cl as ShieldAlert, C as CircleAlert, c4 as Folder, bW as Brain, c5 as CircleCheck, X, U as Upload, F as FileText, R as RefreshCw, c9 as LanguageToggle, c1 as Copy, ce as Mic, cb as FileDown, a1 as Check, v as Search, c6 as PenLine, T as Trash2, a as apiService } from "./index-Sj1NLzeC.js";
import { A as Award } from "./award-CQUKM-ZD.js";
import { P as Printer } from "./printer-D0eKFVxB.js";
/**
...
const EvidenceAnalysis = ({ currentCase, onBack, theme, allProjects = [], onUpdateCase }) => {
  ...
  reactExports.useEffect(() => {
    ...
    if (currentCase) {
      ...
      const docCount = ((_a2 = mapped.allDocuments) == null ? void 0 : _a2.length) || 0;
      setPrefillBanner({
        caseTitle: mapped.caseTitle || "Active Case",
        docCount,
        docs: ((_b2 = mapped.allDocuments) == null ? void 0 : _b2.slice(0, 5)) || []
      });
    } else {
      setHistoryData([]);
  ...
  reactExports.useEffect(() => {
    if (triggerAutoRun && currentCase && !rawForensicResult && !isAuditing) {
      ...
      zt.success(`✓ Case workspace prefilled successfully`, { icon: "💼", duration: 3500 });
      setTimeout(() => {
  ...
  const handlePrefillFromCase = (forceCase = null) => {
    const targetCaseId = linkedCaseId || (forceCase == null ? void 0 : forceCase._id) || (currentCase == null ? void 0 : currentCase._id);
...
Category: ${detectedType}`;
  ...
  const runForensicScanner = async (forceCase = null) => {
    ...
    const activeEvidenceNotes = evidenceNotes.trim() || (targetCase == null ? void 0 : targetCase.description) || "";
...
`;
      const promptQuery = `
        ...
        [Evidence Details]
        File Name: ${evidenceTitle || (targetCase == null ? void 0 : targetCase.name) || "Staged File"}
