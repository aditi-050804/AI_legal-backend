import { r as reactExports, b_ as useOutputLanguage, z as zt, c0 as mapCaseToForm, cc as generateChatResponse, q as getUserData, j as jsxRuntimeExports, a4 as ChevronLeft, c7 as History, c4 as Folder, t as Scale, bS as Gavel, a2 as TrendingUp, l as Shield, u as Eye, bZ as Landmark, bR as Briefcase, F as FileText, c5 as CircleCheck, c9 as LanguageToggle, c2 as Share2, ce as Mic, cb as FileDown, T as Trash2, X, v as Search, a as apiService } from "./index-Sj1NLzeC.js";
...
const StrategyEngine = ({ currentCase, onBack, theme, allProjects = [], onUpdateCase }) => {
  ...
  const activeCaseContext = useActiveCase2();
  const triggerAutoRun = activeCaseContext == null ? void 0 : activeCaseContext.triggerAutoRun;
  const [useActiveCase2, setUseActiveCase] = reactExports.useState(!!currentCase);
...
${mapped.caseFacts || activeObj.description || ""}`
  ...
  const runLitigationSimulation = async (forceCase = null) => {
    ...
    setTimeout(async () => {
      var _a2, _b2, _c2, _d2;
      const currentFacts = caseFacts.trim() || (targetCase == null ? void 0 : targetCase.description) || "";
      const currentTitle = caseTitle.trim() || (targetCase == null ? void 0 : targetCase.name) || "";
      if (!currentFacts) {
...
${currentFacts}`,
        ...
        zt.error(errMsg.length < 100 ? errMsg : "Failed to compile litigation strategy.", { id: toastId });
      } finally {
        setIsAuditing(false);
        setAuditStep("");
      }
...
${factsText}`,
      ...
      const errMsg = e.message || String(e);
      zt.error(errMsg.length < 100 ? errMsg : "Failed to build litigation strategy.", { id: toastId });
    } finally {
      setIsAuditing(false);
      setAuditStep("");
    }
