import { bR as Briefcase, bS as Gavel, F as FileText, bT as Binary, bU as LegalLogo, bV as FileCheck, bW as Brain, bX as Library, y as useLanguage, r as reactExports, ak as reactDomExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion, k as Sparkles, al as Minimize2, am as Maximize2, X, bY as MessageCircle, Z as Zap, l as Shield, z as zt } from "./index-Sj1NLzeC.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2.5 sm:gap-4 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-8 h-8 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl flex items-center justify-center transition-all duration-500 group-hover:scale-110 ${"bg-gradient-to-br from-indigo-500 to-violet-600 shadow-[0_6_16px_rgba(99,102,241,0.35)]"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `w-4 h-4 sm:w-5.5 sm:h-5.5 ${"text-white"}` }) }),
