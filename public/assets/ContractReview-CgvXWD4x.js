import { r as reactExports, b$ as useActiveCase, b_ as useOutputLanguage, c0 as mapCaseToForm, z as zt, cc as generateChatResponse, q as getUserData, j as jsxRuntimeExports, a4 as ChevronLeft, c7 as History, U as Upload, bV as FileCheck, v as Search, n as TriangleAlert, l as Shield, F as FileText, bW as Brain, bS as Gavel, t as Scale, bZ as Landmark, ck as FileSpreadsheet, b as Clock, R as RefreshCw, o as Send, c9 as LanguageToggle, c2 as Share2, ce as Mic, cb as FileDown, c5 as CircleCheck, Y as Plus, T as Trash2, c6 as PenLine, c4 as Folder, X, a as apiService } from "./index-Sj1NLzeC.js";
...
const ContractReview = ({ currentCase, onBack, theme, allProjects = [], onUpdateCase }) => {
  ...
  reactExports.useEffect(() => {
    if (triggerAutoRun && currentCase && !auditResult && !isAuditing) {
      zt.success(`✓ Case workspace prefilled successfully`, { icon: "📄", duration: 3e3 });
      setTimeout(() => {
        var _a2;
        const mapped = mapCaseToForm(currentCase);
